...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def tearDown(self):
        ...
        self.browser.quit()	# closes the browser window		
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertRegex(edith_list_url, '/lists/.+') #assertRegex is a helper function from unittest that checks whether a string matches a regular expression.
...
# This is how a Python script checks if it’s been executed from the command line,
